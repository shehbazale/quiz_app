...
//           {/* <div className="w-20 h-20 border-8 border-gray-500 border-dotted rounded-full animate-spin"></div> */}
//         </div>
//       ) : (
//         <>
...
const Home = () => {
  ...
  useEffect(() => {
    // Only show loading spinner for the initial component mount
    ...
    const timeout = setTimeout(() => setInitialLoading(false), 500);
